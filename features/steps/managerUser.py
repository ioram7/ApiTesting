...
@given(
    'I submit POST request on url "(?P<url>.+)" using: "(?P<email>.+)" value to "email" field, "(?P<password>.+)" value to "password" field')
...
@given(
    'I submit POST request on url "(?P<url>.+)" using: "(?P<name>.+)" value to "name" field, "(?P<job>.+)" value to "job" field')
...
@when(
    'I submit PUT request on url "(?P<url>.+)" using: "(?P<name>.+)" value to "name" field, "(?P<new_job>.+)" value to "job" field')
